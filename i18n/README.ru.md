...
На девятнадцать независимых томов по физике по-прежнему распространяется [GPL-3.0](../licenses/GPL-3.0.txt); ссылки на редактируемые исходники приведены в записях о правах.
